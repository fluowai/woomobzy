...
| `SPECS/IA_SQUAD.md`                                                     | Estratégia de Personas/IA e runtime autônomo multiagente                                                                                          | IMPLEMENTADO — migration aplicada; restart/smoke pendentes         |
...
| `../documentation/RELATORIO_AUDITORIA_COMPLETA_WHATSMEOW_2026-08-15.md` | Auditoria ponta a ponta do Whatsmeow: sessões, concorrência, mídia, WebSocket, banco, Docker, segurança e plano de correção                       | DIAGNÓSTICO CONCLUÍDO — correções aguardando aprovação             |
