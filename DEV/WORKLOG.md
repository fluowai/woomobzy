...
## [2026-08-23] Corre��o do Roteamento de Revendas (Impersonation)
...
- Isso acontecia porque a l�gica em getAuthenticatedPanelPath pulava a regra de Super Admin quando isImpersonating era verdadeiro.

### Corre��o
- Adicionada regra expl�cita no roteador global (src/lib/panelNavigation.ts) para que qualquer contexto (real ou impersonado) cuja organiza��o alvo seja uma Revenda (is_reseller = true) resolva obrigatoriamente para a rota /superadmin.
- O Mega Admin continua indo para /megaadmin ao logar na sua pr�pria conta, e inquilinos normais continuam caindo em /urban ou /rural.
