...
CREATE TABLE public.properties (
  ...
  CONSTRAINT properties_broker_id_fkey FOREIGN KEY (broker_id) REFERENCES public.profiles(id),
  CONSTRAINT properties_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES public.clients(id),
  CONSTRAINT properties_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id)
);
CREATE TABLE public.property_polygons (
  ...
  CONSTRAINT property_polygons_property_id_fkey FOREIGN KEY (property_id) REFERENCES public.properties(id)
);
CREATE TABLE public.leads (
  ...
  CONSTRAINT leads_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id),
...
CREATE TABLE public.site_settings (
  ...
  CONSTRAINT site_settings_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT site_settings_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id)
);
CREATE TABLE public.landing_pages (
  ...
  CONSTRAINT landing_pages_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT landing_pages_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id),
  CONSTRAINT landing_pages_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id)
);
CREATE TABLE public.site_texts (
  ...
  CONSTRAINT site_texts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
CREATE TABLE public.chat_messages (
  ...
  CONSTRAINT chat_messages_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT chat_messages_lead_id_fkey FOREIGN KEY (lead_id) REFERENCES public.leads(id)
);
CREATE TABLE public.due_diligence_items (
  ...
  CONSTRAINT due_diligence_items_property_id_fkey FOREIGN KEY (property_id) REFERENCES public.properties(id)
);
...
CREATE TABLE public.instances (
  ...
  CONSTRAINT instances_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
CREATE TABLE public.contacts (
  ...
  CONSTRAINT contacts_instance_id_fkey FOREIGN KEY (instance_id) REFERENCES public.instances(id)
);
CREATE TABLE public.domains (
  ...
  CONSTRAINT domains_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
...
CREATE TABLE public.saas_settings (
  ...
  CONSTRAINT saas_settings_default_plan_id_fkey FOREIGN KEY (default_plan_id) REFERENCES public.plans(id)
);
...
CREATE TABLE public.rental_contracts (
  ...
  CONSTRAINT rental_contracts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT rental_contracts_property_id_fkey FOREIGN KEY (property_id) REFERENCES public.properties(id),
  CONSTRAINT rental_contracts_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id)
);
...
CREATE TABLE public.whatsapp_instances (
  ...
  CONSTRAINT whatsapp_instances_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id),
  CONSTRAINT whatsapp_instances_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id)
);
CREATE TABLE public.whatsapp_contacts (
  ...
  CONSTRAINT whatsapp_contacts_instance_id_fkey FOREIGN KEY (instance_id) REFERENCES public.whatsapp_instances(id)
);
CREATE TABLE public.whatsapp_chats (
  ...
  CONSTRAINT whatsapp_chats_instance_id_fkey FOREIGN KEY (instance_id) REFERENCES public.whatsapp_instances(id)
);
...
CREATE TABLE public.billing (
  ...
  CONSTRAINT billing_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT billing_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id)
);
...
CREATE TABLE public.developments (
  ...
  CONSTRAINT developments_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT developments_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id)
);
CREATE TABLE public.blocks (
  ...
  CONSTRAINT blocks_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT blocks_development_id_fkey FOREIGN KEY (development_id) REFERENCES public.developments(id)
);
CREATE TABLE public.lots (
  ...
  CONSTRAINT lots_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT lots_development_id_fkey FOREIGN KEY (development_id) REFERENCES public.developments(id),
  CONSTRAINT lots_block_id_fkey FOREIGN KEY (block_id) REFERENCES public.blocks(id)
);
CREATE TABLE public.billings (
  ...
  CONSTRAINT billings_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT billings_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.User (
  ...
  CONSTRAINT User_accessProfileId_fkey FOREIGN KEY (accessProfileId) REFERENCES public.AccessProfile(id)
);
CREATE TABLE public.Organization (
  ...
  CONSTRAINT Organization_planId_fkey FOREIGN KEY (planId) REFERENCES public.Plan(id)
);
...
CREATE TABLE public.ai_agents (
  ...
  CONSTRAINT ai_agents_environment_id_fkey FOREIGN KEY (environment_id) REFERENCES public.environments(id)
);
CREATE TABLE public.agent_channels (
  ...
  CONSTRAINT agent_channels_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_channels_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_workspaces (
  ...
  CONSTRAINT agent_workspaces_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_workspaces_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_triggers (
  ...
  CONSTRAINT agent_triggers_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_triggers_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_permissions (
  ...
  CONSTRAINT agent_permissions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_permissions_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_pipelines (
  ...
  CONSTRAINT agent_pipelines_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_pipelines_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_knowledge_sources (
  ...
  CONSTRAINT agent_knowledge_sources_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_knowledge_sources_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_handoff_rules (
  ...
  CONSTRAINT agent_handoff_rules_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_handoff_rules_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_metrics_config (
  ...
  CONSTRAINT agent_metrics_config_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_metrics_config_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_simulations (
  ...
  CONSTRAINT agent_simulations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_simulations_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.agent_execution_logs (
  ...
  CONSTRAINT agent_execution_logs_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id),
  CONSTRAINT agent_execution_logs_agent_id_fkey FOREIGN KEY (agent_id) REFERENCES public.ai_agents(id)
);
CREATE TABLE public.payment_history (
  ...
  CONSTRAINT payment_history_contract_id_fkey FOREIGN KEY (contract_id) REFERENCES public.rental_contracts(id),
  CONSTRAINT payment_history_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
CREATE TABLE public.contract_renewals (
  ...
  CONSTRAINT contract_renewals_contract_id_fkey FOREIGN KEY (contract_id) REFERENCES public.rental_contracts(id),
  CONSTRAINT contract_renewals_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
CREATE TABLE public.environments (
  ...
  CONSTRAINT environments_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
...
CREATE TABLE public.migration_credentials (
  ...
  CONSTRAINT migration_credentials_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.migration_jobs(id)
);
CREATE TABLE public.migration_steps (
  ...
  CONSTRAINT migration_steps_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.migration_jobs(id)
);
CREATE TABLE public.migration_logs (
  ...
  CONSTRAINT migration_logs_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.migration_jobs(id)
);
CREATE TABLE public.migration_errors (
  ...
  CONSTRAINT migration_errors_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.migration_jobs(id)
);
CREATE TABLE public.migration_file_map (
  ...
  CONSTRAINT migration_file_map_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.migration_jobs(id)
);
CREATE TABLE public.migration_table_map (
  ...
  CONSTRAINT migration_table_map_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.migration_jobs(id)
);
CREATE TABLE public.migration_config_snapshots (
  ...
  CONSTRAINT migration_config_snapshots_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.migration_jobs(id)
);
CREATE TABLE public.email_accounts (
  ...
  CONSTRAINT email_accounts_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT email_accounts_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.emails (
  ...
  CONSTRAINT emails_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.email_accounts(id),
...
CREATE TABLE public.whatsapp_media (
  ...
  CONSTRAINT whatsapp_media_instance_id_fkey FOREIGN KEY (instance_id) REFERENCES public.whatsapp_instances(id),
  CONSTRAINT whatsapp_media_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id)
);
CREATE TABLE public.email_events (
  ...
  CONSTRAINT email_events_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT email_events_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.email_accounts(id),
  CONSTRAINT email_events_email_id_fkey FOREIGN KEY (email_id) REFERENCES public.emails(id)
);
...
CREATE TABLE public.lead_followups (
  ...
  CONSTRAINT lead_followups_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT lead_followups_lead_id_fkey FOREIGN KEY (lead_id) REFERENCES public.leads(id)
);
CREATE TABLE public.email_automation_jobs (
  ...
  CONSTRAINT email_automation_jobs_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT email_automation_jobs_email_id_fkey FOREIGN KEY (email_id) REFERENCES public.emails(id)
);
...
CREATE TABLE public.price_history (
  ...
  CONSTRAINT price_history_property_id_fkey FOREIGN KEY (property_id) REFERENCES public.properties(id),
...
CREATE TABLE public.property_valuations (
  ...
  CONSTRAINT property_valuations_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT property_valuations_triggered_by_fkey FOREIGN KEY (triggered_by) REFERENCES public.profiles(id)
);
CREATE TABLE public.valuation_rules (
  ...
  CONSTRAINT valuation_rules_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id)
);
CREATE TABLE public.comparable_sales (
  ...
  CONSTRAINT comparable_sales_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT comparable_sales_property_id_fkey FOREIGN KEY (property_id) REFERENCES public.properties(id)
);
...
CREATE TABLE public.document_analyses (
  ...
  CONSTRAINT document_analyses_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.documents(id),
  CONSTRAINT document_analyses_property_id_fkey FOREIGN KEY (property_id) REFERENCES public.properties(id)
);
...
CREATE TABLE public.document_external_validations (
  ...
  CONSTRAINT document_external_validations_document_id_fkey FOREIGN KEY (document_id) REFERENCES public.documents(id)
);
CREATE TABLE public.storage_objects (
  ...
  CONSTRAINT storage_objects_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.organizations(id)
);
...
CREATE TABLE public.storage_admin_actions (
  ...
  CONSTRAINT storage_admin_actions_admin_id_fkey FOREIGN KEY (admin_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.quiz_campaigns (
  ...
  CONSTRAINT quiz_campaigns_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT quiz_campaigns_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id)
);
CREATE TABLE public.quiz_submissions (
  ...
  CONSTRAINT quiz_submissions_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
  CONSTRAINT quiz_submissions_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.quiz_campaigns(id),
  CONSTRAINT quiz_submissions_lead_id_fkey FOREIGN KEY (lead_id) REFERENCES public.leads(id)
);
...
CREATE TABLE public.whatsmeow_identity_keys (
  ...
  CONSTRAINT whatsmeow_identity_keys_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_pre_keys (
  ...
  CONSTRAINT whatsmeow_pre_keys_jid_fkey FOREIGN KEY (jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_sessions (
  ...
  CONSTRAINT whatsmeow_sessions_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_sender_keys (
  ...
  CONSTRAINT whatsmeow_sender_keys_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_app_state_sync_keys (
  ...
  CONSTRAINT whatsmeow_app_state_sync_keys_jid_fkey FOREIGN KEY (jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_app_state_version (
  ...
  CONSTRAINT whatsmeow_app_state_version_jid_fkey FOREIGN KEY (jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_app_state_mutation_macs (
  ...
  CONSTRAINT whatsmeow_app_state_mutation_macs_jid_name_fkey FOREIGN KEY (jid) REFERENCES public.whatsmeow_app_state_version(jid),
  CONSTRAINT whatsmeow_app_state_mutation_macs_jid_name_fkey FOREIGN KEY (name) REFERENCES public.whatsmeow_app_state_version(name)
);
CREATE TABLE public.whatsmeow_contacts (
  ...
  CONSTRAINT whatsmeow_contacts_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_chat_settings (
  ...
  CONSTRAINT whatsmeow_chat_settings_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_message_secrets (
  ...
  CONSTRAINT whatsmeow_message_secrets_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
...
CREATE TABLE public.whatsmeow_event_buffer (
  ...
  CONSTRAINT whatsmeow_event_buffer_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.whatsmeow_retry_buffer (
  ...
  CONSTRAINT whatsmeow_retry_buffer_our_jid_fkey FOREIGN KEY (our_jid) REFERENCES public.whatsmeow_device(jid)
);
CREATE TABLE public.leases (
  ...
  CONSTRAINT leases_previous_lease_id_fkey FOREIGN KEY (previous_lease_id) REFERENCES public.leases(id),
  CONSTRAINT leases_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id),
  CONSTRAINT leases_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES auth.users(id),
  ...
  CONSTRAINT leases_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES public.clients(id),
  CONSTRAINT leases_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.clients(id),
  CONSTRAINT leases_guarantor_id_fkey FOREIGN KEY (guarantor_id) REFERENCES public.clients(id),
  CONSTRAINT leases_witness_1_id_fkey FOREIGN KEY (witness_1_id) REFERENCES public.clients(id),
  CONSTRAINT leases_witness_2_id_fkey FOREIGN KEY (witness_2_id) REFERENCES public.clients(id)
);
