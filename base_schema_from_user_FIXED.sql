...
CREATE TABLE public.leads (
  ...
  budget numeric,
  aptitude_interest ARRAY DEFAULT '{}'::text[],
...
CREATE TABLE public.migration_jobs (
  ...
  selected_schemas ARRAY NOT NULL DEFAULT ARRAY['public'::text, 'auth'::text],
  selected_buckets ARRAY NOT NULL DEFAULT ARRAY['whatsapp-media'::text, 'imobzyimg'::text, 'imobzymsg'::text, 'documents'::text, 'exports'::text],
...
CREATE TABLE public.emails (
  ...
  to_email ARRAY DEFAULT '{}'::text[],
  cc_email ARRAY DEFAULT '{}'::text[],
  body_html text,
  body_text text,
  preview text,
  ...
  message_id text,
  in_reply_to text,
  references_ids ARRAY DEFAULT '{}'::text[],
  thread_id text,
  imap_uid bigint,
...
CREATE TABLE public.property_valuations (
  ...
  rules_applied ARRAY DEFAULT '{}'::text[],
  triggered_by uuid,
...
CREATE TABLE public.quiz_submissions (
  ...
  disqualification_reasons ARRAY NOT NULL DEFAULT '{}'::text[],
