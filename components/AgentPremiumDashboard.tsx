  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col md:flex-row items-center md:items-start gap-6 relative overflow-hidden">
        {/* Decor */}
        <div
          className={`absolute top-0 right-0 w-64 h-64 blur-3xl opacity-20 pointer-events-none rounded-full -mr-10 -mt-10 ${isActive ? 'bg-emerald-500' : 'bg-slate-500'}`}
        />
        ...
        <div className="shrink-0 relative">
          ...
          <div
            className={`absolute bottom-0 right-0 w-6 h-6 rounded-full border-4 border-white ${isActive ? 'bg-emerald-500' : 'bg-slate-300'}`}
          />
        </div>
        ...
        <div className="flex-1 text-center md:text-left z-10">
          ...
          <h1 className="text-2xl font-bold text-slate-900 mb-1">
            Olá! Meu nome é{' '}
            <span className="text-emerald-600">{agent.name || 'Bia'}</span>,
            assistente virtual da sua empresa!
          </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <h2 className="text-[11px] font-bold uppercase tracking-widest text-slate-500 ml-1">
            Ações Principais
          </h2>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden border-t-4 border-t-emerald-500 hover:shadow-md transition">
            <div className="p-5">
              ...
              <p className="text-xs text-slate-500 font-medium mb-4">
                Configure informações, produtos, regras e ações do seu
                assistente.
              </p>
              <button
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden border-t-4 border-t-blue-500 hover:shadow-md transition">
            <div className="p-5">
              ...
              <p className="text-xs text-slate-500 font-medium mb-4">
                Ajuste comportamento, tom de voz e preferências gerais
                operacionais.
              </p>
              <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition flex flex-col h-full opacity-70">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-amber-50 text-amber-600 uppercase tracking-widest">
                  180min
                </span>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition flex flex-col h-full relative overflow-hidden">
              <div className="absolute top-2 right-2 text-[8px] font-bold px-1.5 py-0.5 rounded bg-orange-100 text-orange-600 uppercase tracking-widest">
                BETA
              </div>
