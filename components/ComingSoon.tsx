...
const ComingSoon: React.FC<ComingSoonProps> = ({ organizationId, agencyName }) => {
      ...
      <div className="max-w-2xl w-full z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-block mb-6 relative">
            ...
            <img src="/logo-imobzy.png" alt="Imobzy" className="h-20 w-auto relative z-10 drop-shadow-2xl" />
          </div>
          ...
          <p className="text-xl md:text-2xl text-slate-400 font-medium max-w-lg mx-auto leading-tight">
            Uma nova experiência imobiliária de elite está sendo lapidada para você.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="group/input">
                  <div className="relative">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-orange-500 transition-colors" size={20} />
                    <input
                      type="text"
                      required
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="relative group/input">
                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-orange-500 transition-colors" size={20} />
                    <input
                      type="email"
                      required
                      placeholder="E-mail"
                  ...
                  <div className="relative group/input">
                    <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-orange-500 transition-colors" size={20} />
                    <input
                      type="tel"
                      required
                ...
                {error && (
                  <p className="text-red-400 text-xs font-medium px-2">{error}</p>
                )}
