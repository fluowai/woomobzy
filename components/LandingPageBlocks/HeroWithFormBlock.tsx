...
import { HeroWithFormBlockConfig, LandingPageTheme } from '../../types/landingPage';
...
const HeroWithFormBlock: React.FC<HeroWithFormBlockProps> = ({ config, theme }) => {
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl text-center mb-12">
          ...
          <h1 
            ...
            style={{ 
              color: '#ffffff',
              fontFamily: theme.headingFontFamily || "'Playfair Display', serif"
            }}
          >
            {config.title}
          </h1>
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-end -mb-24 px-4 md:px-0">
          ...
          <div className="bg-[#fdfbf7] p-6 rounded-t-xl shadow-2xl border-t-8 border-[#4a5d23]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {submitting ? 'PROCESSANDO...' : submitted ? 'ENVIADO COM SUCESSO!' : config.submitText}
              </button>
            </form>
