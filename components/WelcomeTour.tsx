...
const steps: TourStep[] = [
  {
    ...
    description:
      'Este é o seu centro de comando. Aqui você vê leads, contratos e o financeiro de forma unificada.',
  },
  {
    title: 'Hub de Comunicação',
    description:
      'Acompanhe as últimas mensagens do seu WhatsApp em tempo real e responda leads sem trocar de aba.',
  },
  {
    title: 'Fintech Integrada',
    description:
      'Gerencie cobranças e veja seu VGV provisionado com integração direta ao Asaas.',
  },
];
