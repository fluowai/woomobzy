...
sql = sql.replace(
  /ALTER TABLE public\.whatsmeow_app_state_mutation_macs ADD CONSTRAINT whatsmeow_app_state_mutation_macs_jid_name_fkey FOREIGN KEY \(jid\) REFERENCES public\.whatsmeow_app_state_version\(jid\);/g,
...
sql = sql.replace(
  /ALTER TABLE public\.whatsmeow_app_state_mutation_macs ADD CONSTRAINT whatsmeow_app_state_mutation_macs_jid_name_fkey FOREIGN KEY \(name\) REFERENCES public\.whatsmeow_app_state_version\(name\);/g,
  ''
);
