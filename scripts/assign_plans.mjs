...
async function assignPlans() {
  ...
  console.log(`Planos encontrados: Pro (${proPlan.price_monthly}), Enterprise (${enterprisePlan.price_monthly})`);
  ...
  console.log(`Atribuindo Plano Enterprise para ${enterpriseOrgs.length} imobiliarias (40%)`);
