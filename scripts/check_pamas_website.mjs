...
async function checkCurrentWebsite() {
  const url = 'https://pamasimoveis.com.br/imovel/venda/apartamentos/vinhedo/nova-vinhedo-spazio-reale-condominium-spazio-reale/5314';
  ...
  const wootechMatches = html.match(/https:\/\/s\.wootech\.com\.br\/[^\s"']+/g) || [];
