...
import { isRuralProperty, applyRuralFilter } from '../../utils/propertyNiche.js';
import { FarmValuationService } from '../../services/farmValuationService.js';
import { SicarService } from '../../services/sicarService.js';
import { sanitizeInput, isValidUUID, extractUfFromRuralCode, featureCollectionToMapTarget } from '../../lib/shared-utils.js';
...
export { toNumber, getPropertyAreaHa, normalizeGeometry, buildRuralEnrichment, buildRuralValuation, getComparableStats, calculateGeometryAreaHa };
