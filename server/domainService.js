...
const PLATFORM_SERVICES_MARKER = '# Managed by Imobzy API startup. Do not edit manually.';
const TRAEFIK_FRONTEND_SERVICE = process.env.TRAEFIK_FRONTEND_SERVICE || 'imobzy_frontend@file';
const TRAEFIK_API_SERVICE = process.env.TRAEFIK_API_SERVICE || 'imobzy_api@file';
const DOMAIN_RE =
...
http:
  routers:
    ...
    ${routerBaseName}_frontend:
      ...
      tls:
        certResolver: letsencryptresolver
      service: ${TRAEFIK_FRONTEND_SERVICE}
`;
}
