...
const GENERATED_MARKER = `# Generated by ${PLATFORM_COMMERCIAL_NAME} domainService. Do not edit manually.`;
const PLATFORM_SERVICES_MARKER = `# Managed by ${PLATFORM_COMMERCIAL_NAME} API startup. Do not edit manually.`;
