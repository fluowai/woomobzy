...
const TRAEFIK_DYNAMIC_DIR =
  ...
  path.resolve(process.cwd(), 'traefik', 'dynamic');
...
const TRAEFIK_FRONTEND_SERVICE =
  process.env.TRAEFIK_FRONTEND_SERVICE || 'imobzy_frontend@file';
const TRAEFIK_API_SERVICE =
  process.env.TRAEFIK_API_SERVICE || 'imobzy_api@file';
const DOMAIN_RE =
...
export function buildPlatformTraefikServicesConfig() {
  const frontendUrl =
    process.env.TRAEFIK_FRONTEND_SERVICE_URL || 'http://frontend:80';
