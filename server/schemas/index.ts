...
export const propertySchema = z.object({
  ...
  property_type: z.enum([
    'FAZENDA', 'SITIO', 'CHACARA', 'HARAS', 'AREA_AGRICOLA',
    'AREA_PECUARIA', 'REFLORESTAMENTO', 'LAZER_RURAL', 'ARRENDAMENTO',
    'CASA', 'APARTAMENTO', 'TERRENO', 'COMERCIAL', 'SALAS',
    'LOJAS', 'GALPOES', 'SOBRADO', 'FLAT', 'KITNET'
  ]),
  ...
  status: z.enum(['DRAFT', 'ACTIVE', 'SOLD', 'SUSPENDED', 'ARCHIVED']).optional(),
...
export const leadSchema = z.object({
  ...
  status: z.enum(['NEW', 'CONTACTED', 'QUALIFIED', 'PROPOSITION', 'NEGOTIATION', 'CLOSED_WON', 'CLOSED_LOST']).optional(),
  source: z.enum(['WEBSITE', 'WHATSAPP', 'PHONE', 'REFERRAL', 'PORTAL', 'SOCIAL_MEDIA', 'OFFLINE']).optional(),
