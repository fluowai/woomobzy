import { LandingPageTemplate, buildDesignedTemplate, landingImage, designedSections } from './shared';
export const DESIGNED_SHOWCASE_TEMPLATES: LandingPageTemplate[] = [
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Residenciais', text: 'Casas, apartamentos e condominios para morar com conforto.', icon: '­ƒÅá' },
      { title: 'Comerciais', text: 'Salas, lojas e galpoes para negocios crescerem.', icon: '­ƒÅó' },
      { title: 'Terrenos e lotes', text: 'Oportunidades para investir e construir.', icon: '­ƒù║´©Å' },
      { title: 'Investimentos', text: 'Imoveis com alto potencial de renda.', icon: '­ƒôê' },
      { title: 'Aluguel', text: 'Opcoes selecionadas para locacao.', icon: '­ƒöæ' }
    ],
    cards: [
      { title: 'Casa em Condominio', meta: '4 suites ÔÇó Alphaville', price: 'R$ 1.580.000', image: landingImage.mansion },
      { title: 'Apartamento Alto Padrao', meta: '3 quartos ÔÇó Vila Ema', price: 'R$ 950.000', image: landingImage.interior },
      { title: 'Sala Comercial', meta: '45 m2 ÔÇó Jardim Aquarius', price: 'R$ 420.000', image: landingImage.warehouse },
      { title: 'Terreno em Condominio', meta: '450 m2 ÔÇó Urbanova', price: 'R$ 680.000', image: landingImage.lots }
    ],
    sections: designedSections,
    formTitle: 'Fale comigo',
    formSubtitle: 'Preencha o formulario que retorno rapidinho.',
    faq: ['Como funciona a avaliacao do meu imovel?', 'Quais documentos sao necessarios?', 'Voc├¬s atendem outras regioes?', 'Como e feita a divulgacao?']
  }),
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Acesso rapido', text: 'Conexao direta com as principais rodovias.', icon: '­ƒÜø' },
      { title: 'Mao de obra', text: 'Regiao com oferta de profissionais.', icon: '­ƒôì' },
      { title: 'Seguranca', text: 'Portaria e controle 24h.', icon: '­ƒøí´©Å' },
      { title: 'Infraestrutura', text: 'Servicos essenciais proximos.', icon: '­ƒÅù´©Å' },
      { title: 'Expansao', text: 'Layout preparado para crescer.', icon: '­ƒôê' }
    ],
    cards: [
  ...
  buildDesignedTemplate({
    ...
    features: [
      ...
      { title: 'Pet friendly', text: 'Aceita animais de pequeno e medio porte.', icon: '­ƒÉ¥' },
      { title: 'Garantias', text: 'Fianca, fiador e capitalizacao.', icon: 'Ô£à' },
      { title: 'Agenda online', text: 'Escolha dia, horario e tipo de visita.', icon: '­ƒôà' },
      { title: 'Corretor direto', text: 'Atendimento rapido no WhatsApp.', icon: '­ƒô×' }
    ],
    cards: [
  ...
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Produtividade', text: 'Historico de altas safras.', icon: '­ƒî¥' },
      { title: 'Logistica', text: 'Acesso facil ao asfalto e armazens.', icon: '­ƒøú´©Å' },
      { title: 'Recursos hidricos', text: 'Rios, represas e nascentes.', icon: '­ƒÆº' },
      { title: 'Estrutura completa', text: 'Benfeitorias modernas.', icon: '­ƒÅí' },
      { title: 'Documentacao', text: 'CAR, CCIR, SIGEF e matricula.', icon: '­ƒôä' }
    ],
    cards: [
  ...
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Leads qualificados', text: 'Selecionamos compradores e vendedores reais.', icon: '­ƒÄ»' },
      { title: 'Dados reais', text: 'Informacoes checadas e atualizadas.', icon: '­ƒøí´©Å' },
      { title: 'Agilidade', text: 'Conectamos voce rapidamente.', icon: 'ÔÜí' },
      { title: 'Sigilo total', text: 'Negociacoes protegidas.', icon: '­ƒöÆ' },
      { title: 'Cobertura nacional', text: 'Principais regioes agricolas.', icon: '­ƒôì' }
    ],
    cards: [
      { title: 'Comprador de pecuaria', meta: 'MT ÔÇó ate 3.000 ha', image: landingImage.farm },
      { title: 'Investidor agricola', meta: 'GO ÔÇó soja e milho', image: landingImage.crops },
      { title: 'Proprietario vendedor', meta: 'PR ÔÇó atendimento sigiloso', image: landingImage.broker },
      { title: 'Area de expansao', meta: 'MS ÔÇó oportunidade verificada', image: landingImage.lots }
    ],
    sections: designedSections,
    ...
    faq: ['Os leads sao realmente qualificados?', 'Meus dados ficam seguros?', 'Como recebo os leads?', 'Voc├¬s atuam em todo o Brasil?']
  }),
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Projeto moderno', text: 'Ambientes amplos e integrados.', icon: 'Ô£¿' },
      { title: 'Area gourmet', text: 'Churrasqueira e conforto.', icon: '­ƒì¢´©Å' },
      { title: 'Piscina aquecida', text: 'Lazer com privacidade.', icon: '­ƒÅè' },
  ...
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Piscina com raia', text: 'Climatizada e exclusiva.', icon: '­ƒÅè' },
  ...
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Unidades prioridade', text: 'Escolha antes da abertura.', icon: '­ƒÅó' },
      { title: 'Preco especial', text: 'Condicoes de lancamento.', icon: '­ƒÅÀ´©Å' },
      { title: 'Pagamento exclusivo', text: 'Negociacao antecipada.', icon: '­ƒÆ│' },
      { title: 'Eventos', text: 'Visitas e apresentacoes privadas.', icon: '­ƒÄƒ´©Å' },
      { title: 'Obra transparente', text: 'Acompanhamento por etapas.', icon: '­ƒôå' }
    ],
    cards: [
  ...
  buildDesignedTemplate({
    ...
    features: [
      { title: 'Subsidio', text: 'Desconto que pode chegar alto.', icon: '­ƒÆÁ' },
      { title: 'Use seu FGTS', text: 'Entrada ou parte do financiamento.', icon: '­ƒÆ│' },
      { title: 'Entrada facilitada', text: 'Conquiste seu apartamento.', icon: '­ƒöæ' },
      { title: 'Parcelas acessiveis', text: 'Cabem no bolso da familia.', icon: '­ƒôä' },
      { title: 'Elegibilidade', text: 'Criterios claros para aprovar.', icon: 'Ô£à' }
    ],
    cards: [
