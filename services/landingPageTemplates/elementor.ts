import { LandingPageTemplate, buildElementorReferenceTemplate, landingImage, refThumb } from './shared';
export const ELEMENTOR_REFERENCE_TEMPLATES: LandingPageTemplate[] = [
  ...
  buildElementorReferenceTemplate({
    ...
    faq: ['Como anunciar meu imovel?', 'Voc├¬s atendem locacao?', 'Posso falar com um corretor?', 'Como recebo novidades?']
  }),
  buildElementorReferenceTemplate({
  ...
  buildElementorReferenceTemplate({
    ...
    faq: ['Como funciona a avaliacao?', 'Quais documentos sao necessarios?', 'Voc├¬s atendem outras regioes?', 'Como e feita a divulgacao?']
  }),
  buildElementorReferenceTemplate({
