...
export const INCORPORADORA_TEMPLATES: LandingPageTemplate[] = [
  {
    ...
    name: 'O Loteamento',
    description:
      'Foco em loteamentos e condomínios horizontais (Vídeo, Mapa, Plantas, CTA de Vendas).',
    ...
    blocks: [
      templateBlock(
        ...
        0,
        {
          ...
          subtitle:
            'Loteamento aberto com infraestrutura completa. Cadastre-se e ganhe condições especiais de pré-lançamento.',
          ...
          badges: [
            ...
            },
            {
              ...
              description: 'Água, luz e asfalto',
            },
          ],
        },
        { padding: '0px' },
      ...
      templateBlock(
        ...
        1,
        {
          ...
          zoom: 15,
          markers: [
            { lat: -23.5505, lng: -46.6333, title: 'Local do Loteamento' },
          ],
        },
        { padding: '0px' },
        'full'
      ...
      templateBlock(
        ...
        3,
        {
          ...
          items: [
            ...
            {
              title: 'Asfalto e Guias',
              description: 'Em andamento (80%)',
              time: 'Mar/2025',
            },
            {
              title: 'Liberação para Construir',
      ...
      templateBlock(
        ...
        4,
        {},
        { padding: '40px 20px', backgroundColor: '#022c22' },
        'full'
      ),
    ],
  },
  {
    ...
    description:
      'Apresentação da Incorporadora, VGV, histórico de prédios entregues.',
  ...
  },
  {
    ...
    description:
      'Focado em vender apartamentos na planta. Formulário agressivo no topo, carrosel de plantas.',
    ...
    blocks: [
      templateBlock(
        ...
        0,
        {
          ...
          subtitle:
            'Plantas de 2 e 3 dormitórios com sacada gourmet. Reserve no pré-lançamento.',
          ...
          features: [
            {
              ...
              description: 'Piscina, Academia, Salão de Festas.',
              icon: '🏊',
            },
            {
              title: 'Segurança',
              description: 'Portaria 24h blindada.',
              icon: '🛡️',
            },
            {
              title: 'Localização',
              description: 'Próximo a supermercados e escolas.',
              icon: '📍',
            },
          ],
        },
  ...
  },
  {
    ...
    description:
      'Cores populares (Verde/Azul). Formulário de simulação CAIXA/FGTS logo no topo.',
    ...
    blocks: [
      templateBlock(
        ...
        0,
        {
          ...
          subtitle:
            'Apartamentos com subsídio do governo e uso do FGTS na entrada.',
          ...
          badges: [
            {
              icon: 'home',
              title: 'Programa Governo',
              description: 'Faixas 1, 2 e 3',
            },
            {
              icon: 'dollar-sign',
              title: 'Entrada Facilitada',
              description: 'Parcele em até 48x',
            },
          ],
        },
        { padding: '0px' },
      ...
      templateBlock(
        ...
        1,
        {
          ...
          items: [
            {
              title: 'Simulação',
              description: 'Descubra o valor do seu subsídio e parcelas.',
            },
            {
              title: 'Documentação',
              description: 'Envie RG, CPF, Comprovante de Renda e Endereço.',
            },
            {
              title: 'Aprovação Caixa',
              description: 'Avaliamos seu crédito rapidinho.',
            },
            {
              title: 'Assinatura',
              description: 'Você assina o contrato e garante seu apê!',
            },
          ],
        },
        { padding: '80px 20px', backgroundColor: '#ffffff' }
      ...
      templateBlock(
        ...
        2,
        {},
        { padding: '40px 20px', backgroundColor: '#0ea5e9' },
        'full'
      ),
    ],
  },
  {
    ...
    description:
      'Foco no clube do condomínio, mapa de localização e terrenos (lotes de alto padrão).',
    thumbnail: landingImage.lots,
    ...
    blocks: [
      ...
      templateBlock(
        ...
        4,
        {},
        { padding: '40px 20px', backgroundColor: '#291d15' },
        'full'
      ),
    ],
  },
