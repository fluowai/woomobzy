...
export const PREMIUM_LANDING_PAGE_TEMPLATES: LandingPageTemplate[] = [
  {
    ...
    description: 'Minimalista e focado em apresentar poucas, porém excelentes propriedades (Preto e Dourado).',
    ...
    blocks: [
      ...
      templateBlock(BlockType.TEXT, 2, {
        content: '<h2 style="color:#d4af37;text-align:center">Discrição e Exclusividade</h2><p style="text-align:center;font-size:18px">Nossos corretores atuam com absoluto sigilo para garantir a privacidade de nossos clientes.</p>',
        fontSize: 16,
        fontWeight: 400,
        color: '#ffffff',
        alignment: 'center'
      ...
      templateBlock(BlockType.FOOTER, 4, {}, { padding: '60px 20px', backgroundColor: '#111111' }, 'full')
    ]
  },
  {
    id: 'luxo-minimalist-black',
    name: 'Minimalist Black',
    description: 'Design 100% Preto e Branco. Foco extremo na tipografia e nos espaços em branco.',
    ...
    blocks: [
      templateBlock(BlockType.HERO, 0, {
        ...
        subtitle: 'A seleção mais curada de imóveis contemporâneos da cidade.',
      ...
      templateBlock(BlockType.FOOTER, 4, {}, { padding: '60px 20px', backgroundColor: '#000000' }, 'full')
    ]
  },
  {
    id: 'luxo-coastal-luxury',
    name: 'Coastal Luxury',
    description: 'Focado em imóveis de alto padrão no litoral. Cores bege (areia) e azul marinho.',
    thumbnail: landingImage.mansion,
    ...
    blocks: [
      templateBlock(BlockType.HERO, 0, {
        ...
        backgroundImage: 'https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=80&w=1920&auto=format&fit=crop',
        overlayOpacity: 0.3,
      ...
      templateBlock(BlockType.FEATURES, 1, {
        ...
        layout: 'grid',
        features: [
          { title: 'Pé na Areia', description: 'Acesso direto e exclusivo à praia.', icon: '🌊' },
          { title: 'Vista Definitiva', description: 'Acorde todos os dias olhando o oceano.', icon: '🌅' },
          { title: 'Clubes Exclusivos', description: 'Condomínios com infraestrutura de resort.', icon: '🍹' }
        ]
  ...
  },
  {
    ...
    description: 'Imóveis Off-Market que exigem qualificação prévia (cadastro gigante no topo).',
    thumbnail: landingImage.luxuryApt,
    ...
    blocks: [
      templateBlock(BlockType.HERO_WITH_FORM, 0, {
        ...
        subtitle: 'Propriedades superexclusivas que não estão listadas publicamente.',
        backgroundImage: landingImage.mansion,
        overlayOpacity: 0.8,
      ...
      templateBlock(BlockType.TEXT, 1, {
        content: '<h2 style="text-align:center">Discrição e Exclusividade</h2><p style="text-align:center">Nós entendemos o valor da privacidade. Solicite o acesso e um de nossos Private Brokers entrará em contato.</p>',
        fontSize: 16,
        fontWeight: 400,
        color: '#fafafa',
        alignment: 'center'
  ...
  },
  {
    ...
    description: 'Foco em imóveis com assinatura arquitetônica, com muitos espaços de texto e foto (storytelling).',
    ...
    blocks: [
      templateBlock(BlockType.HERO, 0, {
        ...
        subtitle: 'Casas e apartamentos projetados pelos maiores nomes da arquitetura brasileira.',
        backgroundImage: landingImage.interior,
        overlayOpacity: 0.5,
      ...
      templateBlock(BlockType.BROKER_CARD, 3, {
        ...
        description: 'Temos acesso às propriedades mais cobiçadas das revistas de design.'
      }, { padding: '80px 20px', backgroundColor: '#ffffff' }),
      templateBlock(BlockType.FOOTER, 4, {}, { padding: '40px 20px', backgroundColor: '#18181b' }, 'full')
    ]
  }
];
