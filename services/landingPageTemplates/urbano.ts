...
export const URBANO_TEMPLATES: LandingPageTemplate[] = [
  {
    ...
    name: 'Urban Classic',
    description:
      'Design limpo e tradicional, focado em busca fácil e confiança.',
    ...
    blocks: [
          ...
          features: [
            {
              ...
              description: 'Filtre por bairro, preço e tipo.',
              icon: '🔍',
            },
            {
              title: 'Atendimento Rápido',
              description: 'Corretores online o tempo todo.',
              icon: '⚡',
            },
            {
              title: 'Compra Segura',
              description: 'Assessoria jurídica inclusa.',
              icon: '🛡️',
            },
          ],
        },
      ...
      templateBlock(
        ...
        3,
        {
          ...
          description:
            'Estamos prontos para te ajudar a encontrar o lar perfeito.',
        },
  ...
  },
  {
    ...
    description:
      'Dark mode, moderno, ideal para studios e apartamentos compactos.',
    ...
    blocks: [
      templateBlock(
        ...
        0,
        {
          ...
          subtitle:
            'Studios e compactos perto do metrô. Assine para receber lançamentos.',
  ...
  },
  {
    ...
    name: 'Bairro Prime',
    description:
      'Cores quentes (terracota). Foco no bairro, vida em família e comércio local.',
    ...
    blocks: [
      ...
      templateBlock(
        ...
        1,
        {
          ...
          testimonials: [
            {
              name: 'Família Silva',
              text: 'Encontramos a casa perfeita perto da escola das crianças.',
              rating: 5,
            },
            {
              name: 'Carlos E.',
              text: 'O atendimento foi focado exatamente no que a gente precisava.',
              rating: 5,
            },
          ],
        },
      ...
      templateBlock(
        ...
        4,
        {},
        { padding: '40px 20px', backgroundColor: '#7c2d12' },
        'full'
      ),
    ],
  },
    ...
    blocks: [
      templateBlock(
        ...
        0,
        {
          ...
          subtitle:
            'Processo 100% digital, sem fiador e aprovação em 15 minutos.',
      ...
      templateBlock(
        ...
        1,
        {
          ...
          features: [
            {
              title: 'Sem Fiador',
              description: 'Use cartão de crédito ou seguro fiança.',
              icon: '💳',
            },
            {
              title: '100% Digital',
              description: 'Assinatura pelo celular.',
              icon: '📱',
            },
            {
              title: 'Rápido',
            ...
            {
              title: 'Suporte',
              description: 'Manutenção garantida.',
              icon: '🔧',
            },
          ],
        },
      ...
      templateBlock(
        ...
        4,
        {},
        { padding: '40px 20px', backgroundColor: '#1e293b' },
        'full'
      ),
    ],
  },
  {
    ...
    description:
      'Focado em captar proprietários interessados em vender ou alugar.',
    ...
    blocks: [
      templateBlock(
        ...
        0,
        {
          ...
          subtitle:
            'Avaliação gratuita e sem compromisso feita por especialistas da sua região.',
          backgroundImage: landingImage.house,
          overlayOpacity: 0.6,
          ...
          items: [
            {
              ...
              description: 'Analisamos o mercado local para o preço certo.',
            },
            {
              title: 'Fotos Profissionais',
              description: 'Seu imóvel com a melhor apresentação.',
            },
            {
              title: 'Marketing Direcionado',
              description: 'Anúncios para quem realmente quer comprar.',
            },
            {
              title: 'Fechamento Seguro',
              description:
                'Assessoria jurídica completa até a entrega das chaves.',
            },
          ],
        },
        { padding: '80px 20px', backgroundColor: '#ffffff' }
