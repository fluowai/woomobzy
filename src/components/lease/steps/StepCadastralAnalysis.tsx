...
export const StepCadastralAnalysis: React.FC<Props> = ({
  lease,
  updateField,
}) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                updateField('evaluation_status', e.target.value as any)
              }
              className={inputClass}
            >
              <option value="em_analise">Em Análise</option>
              <option value="aprovado">Aprovado</option>
              <option value="aprovado_com_ressalva">
          ...
          <div>
            <label className={labelClass}>
              Score: {lease.evaluation_score || 0}
            </label>
            <input
              type="range"
              min="0"
              ...
              onChange={(e) =>
                updateField('evaluation_score', Number(e.target.value))
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('credit_score', Number(e.target.value))
              }
              className={inputClass}
              placeholder="0-1000"
            />
        ...
        {riskResult && (
          <div
            className={`mt-4 p-4 rounded-xl border ${
              riskResult.risk_level === 'baixo'
                ? 'bg-emerald-50 border-emerald-200'
                : riskResult.risk_level === 'alto'
        ...
        <label className="flex items-center gap-3 mb-4 p-4 bg-slate-50 rounded-xl cursor-pointer">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              SPC, Serasa, protestos ou ações judiciais
            </p>
          </div>
        </label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('tenant_previous_landlord' as any, e.target.value)
              }
              className={inputClass}
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField(
                  'tenant_previous_landlord_phone' as any,
                  e.target.value
                )
              }
              className={inputClass}
