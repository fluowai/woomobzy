        ...
        {lease.owner_id && (
          <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-xl flex items-center gap-3">
            ...
            <p className="text-xs font-bold text-blue-800">
              Dados carregados automaticamente do proprietário vinculado ao
              imóvel no CRM. Você pode ajustar se necessário.
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('owner_cpf_cnpj' as any, e.target.value)
              }
              className={inputClass}
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('owner_email' as any, e.target.value)
              }
              className={inputClass}
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('owner_phone' as any, e.target.value)
              }
              className={inputClass}
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('owner_address_zip' as any, e.target.value)
              }
              className={inputClass}
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('commission_percent', Number(e.target.value))
              }
              className={inputClass}
              placeholder="Ex: 10"
            />
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                updateField('commission_payer', e.target.value as any)
              }
              className={inputClass}
            >
          ...
          {lease.monthly_rent && lease.commission_percent && (
            <div className="p-4 bg-emerald-50 rounded-xl md:col-span-2">
              <p className="text-sm font-bold text-emerald-700">
                Valor da Comissão: R${' '}
                {(
                  (lease.monthly_rent * (lease.commission_percent || 0)) /
                  100
