...
export const LandingPageManager = lazy(
  () => import('../../views/LandingPageManager')
);
export const LandingPageEditor = lazy(
  () => import('../../views/LandingPageEditor')
);
...
export const Geointeligencia = lazy(
  () => import('../../views/rural/Geointeligencia')
);
export const DueDiligence = lazy(
  () => import('../../views/rural/DueDiligence')
);
export const PortalProprietarioRural = lazy(
  () => import('../../views/rural/PortalProprietarioRural')
);
export const PortalCompradorRural = lazy(
  () => import('../../views/rural/PortalCompradorRural')
);
export const Empreendimentos = lazy(
  () => import('../../views/urban/Empreendimentos')
);
export const Locacao = lazy(() => import('../../views/urban/Locacao'));
export const ComplianceUrbano = lazy(
  () => import('../../views/urban/ComplianceUrbano')
);
export const ExportadorPortais = lazy(
  () => import('../../views/urban/ExportadorPortais')
);
export const PortalProprietarioUrbano = lazy(
  () => import('../../views/urban/PortalProprietarioUrbano')
);
export const PortalCompradorUrbano = lazy(
...
export const TenantManager = lazy(
  () => import('../../views/superadmin/TenantManager')
);
export const GlobalSettings = lazy(
  () => import('../../views/superadmin/GlobalSettings')
);
export const DomainManager = lazy(
  () => import('../../views/superadmin/DomainManager')
);
export const PlanManager = lazy(
  () => import('../../views/superadmin/PlanManager')
);
export const BillingManager = lazy(
