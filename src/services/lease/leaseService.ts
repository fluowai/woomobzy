...
export async function getLease(
  id: string
): Promise<{ success: boolean; data: Lease }> {
...
export async function listSignatures(
  leaseId: string
): Promise<{ success: boolean; data: Signature[] }> {
...
export async function sendSignatureInvitation(
  id: string,
  method?: string
): Promise<{ success: boolean; data: Signature }> {
...
export async function listAdjustments(
  leaseId: string
): Promise<{ success: boolean; data: RentAdjustment[] }> {
...
export async function getTermination(
  leaseId: string
): Promise<{ success: boolean; data: LeaseTermination | null }> {
  return apiFetch(`${BASE_URL}/terminations/${leaseId}`);
}

export async function createTermination(
  data: Partial<LeaseTermination>
): Promise<{ success: boolean; data: LeaseTermination }> {
...
export async function getDashboardResumo(): Promise<{
  success: boolean;
  data: LeaseDashboardResumo;
}> {
  return apiFetch(`${BASE_URL}/dashboard/resumo`);
}

export async function getDashboardTimeline(): Promise<{
  success: boolean;
  data: LeaseTimelineEvent[];
}> {
