      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between max-w-7xl">
        <a href={INOVE_URL} className="flex items-center gap-2 z-50 relative">
          ...
          <span className="font-bold text-xl tracking-tight text-slate-800">
            DELAZARI
            <span className="text-blue-600 text-sm align-top ml-1">
              IMÓVEIS
            </span>
          </span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <a
            href={INOVE_URL}
            className="px-5 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-full hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20"
          >
      ...
      {isOpen && (
        ...
        >
          <a
            ...
            className="text-xl font-semibold border-b border-slate-100 pb-4"
          >
            Soluções
          </a>
          <a
          ...
          <div className="mt-auto pb-8 flex flex-col gap-4">
            <a
              href={INOVE_URL}
              className="w-full py-4 text-center border border-slate-200 rounded-xl font-medium"
            >
              Entrar no painel
            </a>
            <a
              href={INOVE_URL}
              className="w-full py-4 text-center bg-blue-600 text-white rounded-xl font-medium"
            >
              Agendar demonstração
            </a>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <p className="text-blue-600 font-semibold tracking-wider text-sm mb-4 uppercase">
              A NOVA ERA DA GESTÃO IMOBILIÁRIA
            </p>
            <h1 className="text-5xl lg:text-6xl font-extrabold text-[#0B1A40] leading-[1.1] mb-6">
              O sistema imobiliário 360º para quem{' '}
              <span className="text-blue-600">quer crescer.</span>
            </h1>
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              CRM, imóveis, leads, atendimento, contratos, locação, marketing e
              inteligência artificial em uma única plataforma.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <a
                href={INOVE_URL}
                className="px-8 py-4 bg-blue-600 text-white text-center font-medium rounded-full hover:bg-blue-700 transition-all shadow-xl shadow-blue-600/20 flex items-center justify-center gap-2"
              >
                Agendar demonstração <ArrowRight size={18} />
              </a>
              <a
                href="#recursos"
                className="px-8 py-4 bg-white text-slate-700 border border-slate-200 text-center font-medium rounded-full hover:bg-slate-50 transition-all"
              >
                Conhecer recursos
              </a>
            </div>
            ...
            <div className="relative rounded-2xl shadow-2xl overflow-hidden border border-slate-200/50 bg-[#0B1A40]">
              ...
              <div className="h-12 border-b border-white/10 flex items-center px-4 gap-2">
                ...
                <div className="ml-4 font-semibold text-white text-sm flex items-center gap-2">
                  <div className="w-5 h-5 bg-blue-600 rounded flex items-center justify-center text-[10px]">
                    IN
                  </div>
                  INOVE
                </div>
              ...
              <div className="p-6 grid grid-cols-12 gap-6 h-[400px]">
                ...
                <div className="col-span-3 space-y-4">
                  {[...Array(6)].map((_, i) => (
                    <div
                      key={i}
                      className={`h-8 rounded-md flex items-center px-3 ${i === 0 ? 'bg-blue-600 text-white' : 'text-slate-400'}`}
                    >
                      <div className="w-4 h-4 rounded bg-current opacity-70 mr-3"></div>
                      <div
                        className={`h-2 rounded ${i === 0 ? 'bg-white/80 w-16' : 'bg-slate-600 w-20'}`}
                      ></div>
                    </div>
                  ))}
                </div>
    ...
    <section className="py-12 border-y border-slate-100 bg-white">
      <div className="container mx-auto px-4 max-w-7xl text-center">
        <p className="text-sm font-semibold tracking-wider text-slate-400 uppercase mb-8">
          Tecnologia para imobiliárias de todos os portes
        </p>
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
          <div className="font-bold text-xl flex items-center gap-2">
            <div className="w-6 h-6 bg-current rounded-full"></div> SOLARIS
          </div>
          <div className="font-bold text-xl flex items-center gap-2">
            <div className="w-6 h-6 bg-current rounded-sm"></div> LUMINA
          </div>
          <div className="font-bold text-xl flex items-center gap-2">
            <div className="w-6 h-6 bg-current rotate-45"></div> NOVIA
          </div>
          <div className="font-bold text-xl flex items-center gap-2">
            <div className="w-6 h-6 border-[3px] border-current rounded-full"></div>{' '}
            VERDEMAR
          </div>
          <div className="font-bold text-xl flex items-center gap-2">
            <div className="w-6 h-6 bg-current rounded-tl-xl rounded-br-xl"></div>{' '}
            PRIME
          </div>
        </div>
      </div>
  ...
  const features = [
    {
      ...
      desc: 'Cadastro completo, fotos, características, valores e disponibilidade em tempo real.',
    },
    {
      icon: <Users size={24} />,
      title: 'CRM e funil de leads',
      desc: 'Organize leads, acompanhe o funil de vendas e aumente suas conversões.',
    },
    {
      icon: <MessageSquare size={24} />,
      title: 'Atendimento omnichannel',
      desc: 'Centralize WhatsApp, e-mail, chat e ligações em um único lugar.',
    },
    {
      icon: <FileText size={24} />,
      title: 'Contratos e documentos',
      desc: 'Crie, envie, assine e armazene contratos com segurança e validade jurídica.',
    },
    {
      icon: <TrendingUp size={24} />,
      title: 'Marketing imobiliário',
      desc: 'Campanhas, landing pages, disparo de e-mails e gestão de anúncios integrada.',
    },
    {
      icon: <Key size={24} />,
      title: 'Locação simplificada',
      desc: 'Controle de locações, vistorias, reajustes, renovações e boletos em poucos cliques.',
    },
    {
      icon: <BarChart3 size={24} />,
      title: 'Relatórios inteligentes',
      desc: 'Dashboards completos para tomar decisões com base em dados reais.',
    },
    {
      icon: <Smartphone size={24} />,
      title: 'Aplicativo mobile',
      desc: 'Acesse tudo de onde estiver e mantenha sua equipe sempre conectada.',
    },
  ];
    ...
    <section id="recursos" className="py-24 bg-slate-50">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1A40]">
            Tudo o que sua imobiliária precisa em um só lugar.
          </h2>
        </div>
    ...
    <section className="py-24 bg-[#0B1A40] text-white overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-blue-400 font-semibold tracking-wider text-sm mb-4 uppercase">
              TECNOLOGIA E AUTOMAÇÃO
            </p>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Inteligência que transforma{' '}
              <span className="text-blue-400">dados</span> em negócios.
            </h2>
            <p className="text-slate-300 text-lg mb-8 leading-relaxed">
              Utilizamos automações e inteligência artificial para otimizar seu
              tempo, aumentar a produtividade do time e melhorar a experiência
              do cliente.
            </p>
          ...
          <div className="relative">
            ...
            <div className="bg-slate-800 rounded-2xl overflow-hidden shadow-2xl border border-slate-700 relative z-10 aspect-video lg:aspect-square max-h-[400px]">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="uppercase tracking-widest text-xs font-bold text-white mb-2">
                  APARTAMENTO
                </div>
                ...
                <div className="flex gap-2 mb-4">
                  <span className="text-xs px-2 py-1 bg-white/20 rounded backdrop-blur text-white">
                    90m²
                  </span>
                  <span className="text-xs px-2 py-1 bg-white/20 rounded backdrop-blur text-white">
                    2 vagas
            ...
            >
              <div className="text-center">
                <p className="text-xs font-semibold tracking-wider text-slate-400 mb-4 uppercase">
                  SCORE DO LEAD
                </p>
                <div className="w-32 h-32 mx-auto relative flex items-center justify-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[10px] text-blue-400 font-medium uppercase tracking-widest mt-1">
                      MUITO QUENTE
                    </p>
                  </div>
                </div>
  ...
  return (
    <section className="py-24 bg-white overflow-x-hidden">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className="text-blue-600 font-semibold tracking-wider text-sm mb-4 uppercase">
            FUNIL DE VENDAS VISUAL E EFICIENTE
          </p>
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1A40]">
            Acompanhe cada etapa do seu funil em tempo real.
          </h2>
        </div>
        ...
        <div className="flex gap-4 overflow-x-auto pb-8 hide-scrollbar">
          {columns.map((col, i) => (
            <div
              key={i}
              className={`flex-1 min-w-[280px] rounded-xl p-4 ${col.color} border border-slate-100`}
            >
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((card) => (
                  <div
                    key={card}
                    className="bg-white p-3 rounded-lg shadow-sm border border-slate-100 cursor-grab active:cursor-grabbing hover:border-blue-300 transition-colors"
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 rounded-full bg-slate-200 flex-shrink-0 overflow-hidden">
                        <img
                          src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${col.title}${card}`}
        ...
        <p className="text-center text-[11px] text-slate-400 mt-6">
          Exemplo ilustrativo do funil do produto — os dados exibidos não são
          reais.
        </p>
        ...
        <p className="text-center text-[11px] text-slate-400 mt-4">
          Interface ilustrativa do produto. Resultados dependem da operação de
          cada imobiliária.
        </p>
      </div>
    </section>
    ...
    <section className="py-24 bg-slate-50">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1A40]">
            Mais eficiência, mais resultados, mais crescimento.
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-slate-500 text-sm">
                da média das imobiliárias que usam nossa plataforma.
              </p>
            </div>
            <div className="mt-8 flex items-end gap-2 h-16">
              {[30, 45, 60, 80, 100].map((h, i) => (
                <div
                  key={i}
                  className="w-8 bg-blue-100 rounded-t-sm relative group"
                >
                  <div
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-slate-500 text-sm">
                para leads qualificados com atendimento centralizado.
              </p>
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-4">
                Dashboards e relatórios para decisões estratégicas.
              </p>
            </div>
            <div className="mt-8 flex justify-center text-blue-500">
              <svg
...
function Testimonials() {
  const testimonials = [
    {
      text: 'A plataforma transformou nossa rotina. Centralizamos tudo, respondemos mais rápido e aumentamos nossas vendas em 30%.',
      name: 'Patrícia Alencar',
      role: 'Diretora Comercial',
      company: 'Lumina Imobiliária',
    },
    {
      text: 'A automação e o funil de leads nos deram clareza do processo e mais previsibilidade no fechamento dos negócios.',
      name: 'Ricardo Melo',
      role: 'Gerente de Vendas',
      company: 'Prime Imobiliária',
    },
    {
      text: 'Relatórios inteligentes e atendimento integrado nos ajudam a tomar decisões melhores todos os dias.',
      name: 'Juliana Ribeiro',
      role: 'Sócia Proprietária',
      company: 'Horizon Imóveis',
    },
  ];
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-auto">
                <div className="w-12 h-12 rounded-full bg-slate-300 overflow-hidden">
                  <img
                    src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${test.name}`}
                    alt={test.name}
  ...
  return (
    <section id="planos" className="py-24 bg-slate-50">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className="text-blue-600 font-semibold tracking-wider text-sm mb-4 uppercase">
            PLANOS FLEXÍVEIS PARA SUA IMOBILIÁRIA
          </p>
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1A40]">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-center">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200">
            <h3 className="text-2xl font-bold text-[#0B1A40] mb-2">
              Essencial
            </h3>
            <p className="text-sm text-slate-500 mb-6">
              Para começar a organizar e vender mais.
            </p>
            <div className="mb-6">
            ...
            <a
              href={INOVE_URL}
              className="block w-full py-3 text-center border-2 border-slate-200 text-slate-700 font-semibold rounded-xl hover:border-blue-600 hover:text-blue-600 transition-colors"
            >
              Ver detalhes
            </a>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border-2 border-blue-600 shadow-xl relative transform md:-translate-y-4">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Para imobiliárias que querem ganhar escala.
            </p>
            <div className="mb-6">
              <span className="text-sm text-slate-500">R$</span>
            ...
            <a
              href={INOVE_URL}
              className="block w-full py-3 text-center bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20"
            >
              Ver detalhes
            </a>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Para equipes que buscam o máximo resultado.
            </p>
            <div className="mb-6">
              <span className="text-sm text-slate-500">R$</span>
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="bg-[#0B1A40] rounded-3xl p-8 md:p-16 text-white grid md:grid-cols-2 gap-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-blue-400 font-semibold tracking-wider text-xs mb-4 uppercase">
              VAMOS CONVERSAR
            </p>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Pronto para elevar sua imobiliária ao próximo nível?
            </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Conheça o sistema antes de qualquer decisão.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative z-10 bg-white rounded-2xl p-6 md:p-8 text-slate-800">
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                window.location.href = INOVE_URL;
              }}
            >
              <div>
              ...
              <button
                type="submit"
                className="w-full py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20"
              >
                Agendar demonstração
              </button>
            </form>
    ...
    <footer className="bg-[#0B1A40] pt-16 pb-8 border-t border-slate-800">
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="col-span-1">
            <a href={INOVE_URL} className="flex items-center gap-2 mb-6">
              ...
              <span className="font-bold text-xl tracking-tight text-white">
                DELAZARI
                <span className="text-blue-500 text-sm align-top ml-1">
                  IMÓVEIS
                </span>
              </span>
            </a>
            <p className="text-slate-400 text-sm mb-6">
              Plataforma completa de gestão imobiliária para aumentar
              produtividade, vendas e resultados da sua imobiliária.
            </p>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p>
            © {new Date().getFullYear()} Delazari Imóveis Revenda (Inove
            Brokers). Todos os direitos reservados.
          </p>
          <div className="flex gap-4">
            <a href="#" className="hover:text-white transition-colors">
