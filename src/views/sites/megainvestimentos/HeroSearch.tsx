      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-5xl">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row items-stretch">
          ...
          <div className="flex-1 flex items-center gap-3 p-4 border-b md:border-b-0 md:border-r border-gray-200 cursor-pointer hover:bg-gray-50/50">
            ...
            <div className="flex-1">
              <input type="text" readOnly placeholder="Tipo" className="w-full bg-transparent outline-none cursor-pointer text-gray-800 font-medium" />
            </div>
          ...
          <div className="flex-1 flex items-center gap-3 p-4 border-b md:border-b-0 md:border-r border-gray-200 cursor-pointer hover:bg-gray-50/50">
            ...
            <div className="flex-1">
              <input type="text" readOnly placeholder="Dorms" className="w-full bg-transparent outline-none cursor-pointer text-gray-800 font-medium" />
            </div>
            <ChevronDown className="text-gray-400" size={16} />
          </div>
          ...
          <div className="flex-[2] flex items-center gap-3 p-4 cursor-text">
            ...
            <input type="text" placeholder="Pesquise código, cidade, bairro..." className="w-full bg-transparent outline-none text-gray-800 placeholder-gray-500 font-medium" />
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-8">
          {[
            ...
            <a key={idx} href="#" className="flex items-center gap-2 px-5 py-2.5 bg-white/15 backdrop-blur-md border border-white/30 rounded-full text-white text-sm font-medium hover:bg-white/25 hover:-translate-y-0.5 transition-all">
