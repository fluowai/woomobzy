...
test.describe('Onda 1 - Módulo Urbano: Repasse e Corretores (RLS)', () => {
  ...
  test('Corretor deve acessar painel de imóveis e ver apenas os permitidos pelo RLS', async ({ page }) => {
    ...
    await page.getByRole('link', { name: /Imóveis|Captações/i }).first().click();
