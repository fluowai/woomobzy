    ...
    <div className="w-full max-w-[1600px] mx-auto space-y-8 pb-12 font-sans text-gray-900">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-blue-100 mt-2 text-sm md:text-base max-w-xl">
              Análise aprofundada de carteira, leads, vendas e performance
              comercial do portfólio urbano.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white text-sm font-semibold rounded-xl backdrop-blur-sm transition-all flex items-center gap-2"
            >
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          >
            <item.icon
              className={`absolute -right-4 -bottom-4 w-24 h-24 opacity-[0.03] transform group-hover:scale-110 transition-transform duration-500 ${item.color}`}
            />
            <div
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Comparativo Captações vs Novos Leads
              </p>
            </div>
                  ...
                  <div className="mb-2 flex justify-between text-xs font-bold uppercase tracking-widest text-gray-500">
                    ...
                    <span className="text-gray-900">
                      ...
                      <span className="text-gray-400 font-medium">
                        ({Math.round((item.value / leads.length) * 100)}%)
                      </span>
                    </span>
                  </div>
