      ...
      <div className="mx-auto max-w-4xl space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">
                Guia DNS {COMMERCIAL_PRODUCT_NAME}
              </h1>
              <p className="text-sm text-slate-500">
                Como apontar apenas o site do cliente para o servidor, sem mexer
                no e-mail.
              </p>
            </div>
          </div>
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-6">
          <h2 className="mb-4 text-lg font-bold">
            Registros que devem apontar para a {COMMERCIAL_PRODUCT_NAME}
          </h2>
          ...
          <p className="mt-3 text-sm text-slate-600">
            Alternativa: o registro <span className="font-mono">www</span> pode
            ser CNAME para o dominio raiz, desde que o dominio raiz esteja
            apontando para o IP acima.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-amber-200 bg-amber-50 p-6">
          ...
          <p className="text-sm leading-relaxed text-amber-900">
            Para manter o e-mail funcionando na hospedagem atual, nao mexa em
            registros MX, TXT SPF, DKIM, mail, smtp, pop, webmail, ftp, ns1 ou
            ns2. Altere apenas o A do dominio raiz e o A/CNAME do www.
          </p>
        </section>
        ...
        <section className="grid gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-slate-200 bg-white p-5">
            <h3 className="mb-3 flex items-center gap-2 font-bold">
              <CheckCircle2 size={17} className="text-green-600" /> Quando
              estiver correto
            </h3>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-5">
            <h3 className="mb-3 flex items-center gap-2 font-bold">
              <AlertTriangle size={17} className="text-amber-600" /> Quando
              ainda estiver errado
            </h3>
            <p className="text-sm text-slate-600">
              Se aparecer outro IP, como o IP da hospedagem antiga, edite o
              registro A correspondente. O TTL 3600 pode levar ate algumas horas
              para propagar.
            </p>
          </div>
        </section>
