...
const SiteSetupWizard: React.FC = () => {
  ...
  const handleLogoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async () => {
      ...
      try {
        const colors = await geminiService.extractColorsFromLogo(
          base64,
          file.type
        );
  ...
  const handleStartMigration = async () => {
    ...
    setMigrating(true);
    setMigrationLogs([
      'Conectando ao sistema de importação...',
      'Validando URL: ' + siteData.migrationUrl,
    ]);
  ...
  const handlePublish = async () => {
    ...
    try {
      const template =
        LANDING_PAGE_TEMPLATES.find(
          (t) => t.id === siteData.selectedTemplateId
      ...
      const newPage = await landingPageService.create({
        ...
        propertySelection: { mode: 'all' as any, propertyIds: [] },
        formConfig: {
          enabled: true,
          fields: [],
          submitText: 'Enviar',
          ...
          <div className="z-10 relative">
            ...
            <div className="space-y-8">
              {[
                ...
                <div
                  key={s.n}
                  className={`flex items-center gap-4 transition-all duration-300 ${step === s.n ? 'opacity-100 scale-105 ml-2' : step > s.n ? 'opacity-60' : 'opacity-30'}`}
                >
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${step === s.n ? 'bg-indigo-600 shadow-[0_0_15px_rgba(79,70,229,0.5)]' : step > s.n ? 'bg-green-500 text-slate-900' : 'bg-slate-800'}`}
                  >
        ...
        <div className="md:w-2/3 p-10 bg-white flex flex-col">
          ...
          {step === 1 && (
            <div className="flex-1 animate-fadeIn">
              ...
              <p className="text-slate-500 mb-8">
                Vamos preencher a essência do seu novo site. Use nossa IA para
                criar algo irresistível se estiver sem criatividade.
              </p>
              ...
              <div className="mt-6 p-4 bg-indigo-50 rounded-xl border border-indigo-100 flex items-center justify-between">
                <div className="text-sm font-medium text-indigo-900 w-2/3">
                  Poupe tempo! Deixe a nossa inteligência entender sua empresa e
                  redigir o marketing por você.
                </div>
                <button
          ...
          {step === 2 && (
            <div className="flex-1 animate-fadeIn flex flex-col h-full">
              ...
              <p className="text-slate-500 mb-6">
                Suba sua Logo (a IA arruma as cores) e escolha o template
                matador.
              </p>
              ...
              <div className="border-2 border-dashed border-slate-300 rounded-2xl p-6 mb-6 flex items-center gap-6 group hover:border-indigo-400 transition-colors relative">
                ...
                <div>
                  <h3 className="font-bold text-slate-800 text-lg">
                    Conectar Identidade Visual
                  </h3>
                  <p className="text-sm text-slate-500">
                    A Inteligência Artificial varre o arquivo e puxa as cores
                    dominantes em HEX.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 mb-6">
                <div className="flex-1 p-3 border border-slate-100 rounded-xl flex items-center gap-3 bg-slate-50">
                  ...
                  <div>
                    ...
                    <p className="font-mono text-sm">{siteData.primaryColor}</p>
                  </div>
                </div>
                <div className="flex-1 p-3 border border-slate-100 rounded-xl flex items-center gap-3 bg-slate-50">
                  <input
              ...
              <div className="flex-1 mt-6">
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-1 mb-3">
                  Modelos Premium (
                ...
                <div
                  className="grid grid-cols-2 lg:grid-cols-3 gap-4 overflow-y-auto pr-2 custom-scrollbar pb-6"
                      ...
                      >
                        ...
                        <div className="h-44 w-full bg-slate-100 relative flex flex-col justify-start overflow-hidden">
                          ...
                          <div
                            ...
                            style={{
                              backgroundImage: `url(${
                                t.id === 'sonho-rural-premium'
                                  ? 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
                                  : t.id === 'vida-rural-autentica'
                                    ? 'https://images.unsplash.com/photo-1590001155093-a3c66ab0c3ff?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
                                    : t.id === 'investimento-garantido'
                                      ? 'https://images.unsplash.com/photo-1423483641154-5411ec9c0e0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
                                      : t.id === 'urban-elegance'
                          ...
                          <div className="z-10 w-full p-2 flex justify-between items-center bg-white/20 backdrop-blur-md border-b border-white/10">
                            <div className="text-xl filter drop-shadow-lg">
                              {t.thumbnail}
                            </div>
                          ...
                          <div className="z-10 flex-1 flex flex-col justify-center items-center p-4">
                            ...
                            <div
                              className="w-1/3 h-6 rounded border border-white/40 flex items-center justify-center backdrop-blur-md shadow-xl"
                              style={{
                                backgroundColor: `${t.themeConfig.primaryColor}80`,
                              }}
                            >
                          ...
                          <div className="flex items-center gap-1 mt-3">
                            <div
                              ...
                              style={{
                                backgroundColor:
                                  siteData.selectedTemplateId === t.id &&
                                  siteData.primaryColor !== '#2563eb'
                                    ? siteData.primaryColor
                                    : t.themeConfig.primaryColor,
                              }}
                            />
                            <div
                              className="w-4 h-4 rounded-full border border-slate-200"
                              style={{
                                backgroundColor:
                                  siteData.selectedTemplateId === t.id &&
                                  siteData.secondaryColor !== '#10b981'
                                    ? siteData.secondaryColor
                                    : t.themeConfig.secondaryColor,
                              }}
                            />
                          </div>
                        </div>
          ...
          {step === 3 && (
            <div className="flex-1 animate-fadeIn">
              ...
              <p className="text-slate-500 mb-8">
                Já tem propriedades em outro sistema ou portal? Nós puxamos
                quase tudo pra você começar com site cheio!
              </p>

              <div className="mb-6">
                <label className="block text-sm font-bold text-slate-700 mb-2">
                  URL de Origem (do portal externo ou site antigo)
                </label>
                <input
                  type="url"
                ...
                <div className="mt-6 p-4 bg-slate-900 border border-slate-800 rounded-xl">
                  ...
                  <div className="space-y-1 font-mono text-xs">
                    {migrationLogs.map((log, i) => (
                      <div
                        key={i}
                        className={`flex items-start gap-2 ${log.includes('❌') ? 'text-red-400' : log.includes('✅') ? 'text-green-400' : 'text-slate-300'}`}
                      >
          ...
          {step < 4 && (
            <div className="mt-auto pt-6 flex flex-row-reverse items-center justify-between border-t border-slate-100">
              ...
              >
                {step === 3 ? 'Pular / Continuar' : 'Próxima Etapa'}{' '}
                <ArrowRight size={18} />
              </button>
              {step > 1 && (
                <button
          ...
          {step === 4 && (
            <div className="flex-1 animate-fadeIn flex flex-col items-center justify-center text-center">
              ...
              <p className="text-slate-500 max-w-md mx-auto mb-10 text-lg leading-relaxed">
                Tudo parametrizado. Vamos montar cada bloco meticulosamente do
                seu novo website de alta conversão.
              </p>
