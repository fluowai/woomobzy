...
const BrandLockup = ({ compact = false }: { compact?: boolean }) => (
  <div className="flex items-center gap-3">
    <div
      className={`flex items-center justify-center rounded-xl bg-gradient-to-br from-[#3b82f6] to-[#8b5cf6] p-[2px] shadow-lg ${compact ? 'h-8 w-8' : 'h-10 w-10'}`}
    >
      <div className="flex h-full w-full items-center justify-center rounded-[10px] bg-[#020617]">
        ...
        >
          <path
            d="M3 21L7.5 12L12 21L16.5 12L21 21M3 12L7.5 3L12 12L16.5 3L21 12"
      ...
      <main id="topo" className="relative z-10">
        <section className="mx-auto grid max-w-[1440px] gap-16 px-6 pb-24 pt-16 lg:grid-cols-[1fr_1.1fr] lg:px-8 xl:pt-24 xl:pb-32">
          ...
          >
            <motion.div
              variants={fadeIn}
              className="inline-flex items-center gap-2 rounded-full border border-[#3b82f6]/30 bg-[#3b82f6]/10 px-4 py-2 mb-8"
            >
            ...
            <motion.h1
              variants={fadeIn}
              className="text-5xl font-black leading-[1.1] tracking-tight text-white md:text-6xl xl:text-7xl"
            >
              O{' '}
              <span className="bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] bg-clip-text text-transparent">
                CRM imobiliário
              </span>{' '}
              completo para quem quer crescer.
            </motion.h1>

            <motion.p
              variants={fadeIn}
              className="mt-6 text-xl font-medium leading-relaxed text-white/60"
            >
              Gestão de imóveis, atendimento omnichannel, marketing, contratos e
              relatórios em um único sistema de alta performance.
            </motion.p>
                  ...
                  <div className="grid gap-4 lg:grid-cols-[1fr_1fr]">
                    ...
                    <div className="rounded-2xl border border-white/5 bg-white/5 p-5">
                      ...
                      <div className="space-y-3">
                        {[
                          {
                            name: 'Apt. Alto Padrão',
                            city: 'R$ 1.850.000',
                            img: 'urban_sea_view.png',
                          },
                          {
                            name: 'Casa Condomínio',
                            city: 'R$ 2.450.000',
                            img: 'urban_gated_community.png',
                          },
                        ].map((item, index) => (
                          <div
                            key={item.name}
        ...
        <section
          id="solucoes"
          className="relative mx-auto max-w-[1440px] px-6 py-24 lg:px-8 xl:py-32"
        >
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-[760px] text-lg font-medium leading-relaxed text-white/60">
              Da captação ao pós-venda, conectamos processos, pessoas e
              informações para você focar no que realmente importa: fechar
              grandes negócios.
            </p>
          </motion.div>
          ...
          <div className="mx-auto grid max-w-[1440px] gap-16 px-6 py-24 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:px-8 xl:py-32">
            ...
            >
              ...
              <p className="mt-6 max-w-[540px] text-lg font-medium leading-relaxed text-white/60">
                Utilizamos a mais alta tecnologia de automações e inteligência
                artificial para otimizar seu tempo, aumentar a produtividade do
                time e revolucionar a experiência do cliente.
              </p>
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/5 p-4 shadow-2xl">
                ...
                >
                  <p className="text-xs font-black uppercase tracking-widest text-white/70 text-center mb-4">
                    Score do Lead
                  </p>
                  ...
                  <div className="mt-6 space-y-2">
                    ...
                    <p className="text-center text-[10px] font-bold text-white/50 uppercase">
        ...
        <section
          id="clientes"
          className="relative border-t border-white/5 py-24 xl:py-32"
        >
          ...
          <div className="mx-auto max-w-[1440px] px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl font-black text-white md:text-5xl">
                Histórias de quem{' '}
                <span className="text-[#6366f1]">cresce com a gente</span>
              </h2>
            </motion.div>
            ...
            >
              {testimonials.map((item, index) => (
                ...
                >
                  <p className="text-6xl font-serif text-[#3b82f6]/20 absolute top-6 left-6">
                    "
                  </p>
        ...
        <section
          id="cta-final"
          className="mx-auto max-w-[1440px] px-6 py-12 lg:px-8 pb-24"
        >
          <motion.div
          ...
          >
            ...
            <div className="grid gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-center relative z-10">
              <div>
                <h2 className="text-4xl font-black leading-tight text-white md:text-5xl">
                  Pronto para elevar sua imobiliária{' '}
                  <span className="text-[#6366f1]">ao próximo nível?</span>
                </h2>
                <p className="mt-6 max-w-[500px] text-lg font-medium leading-relaxed text-white/60">
                  Agende uma demonstração gratuita e descubra como a{' '}
                  {COMMERCIAL_PRODUCT_NAME} vai transformar completamente sua
                  operação.
                </p>
                <div className="mt-8 flex flex-col sm:flex-row gap-6 text-sm font-bold text-white/70">
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle2 size={18} className="text-[#3b82f6]" /> Sem
                    compromisso
                  </div>
                </div>
              </div>
      ...
      <footer className="border-t border-white/5 bg-[#020617]">
        <div className="mx-auto grid max-w-[1440px] gap-12 px-6 py-20 lg:grid-cols-[1.5fr_1fr_1fr_1fr] lg:px-8">
          <div>
            ...
            <p className="mt-6 max-w-[320px] text-sm font-medium leading-relaxed text-white/50">
              O CRM imobiliário definitivo para imobiliárias urbanas e rurais
              que buscam controle total, máxima produtividade e crescimento
              escalável.
            </p>
          ...
          {footerColumns.map((column) => (
            <div key={column.title}>
              <p className="text-sm font-black uppercase tracking-widest text-white/90 mb-6">
                {column.title}
              </p>
        ...
        <div className="border-t border-white/5">
          <div className="mx-auto flex max-w-[1440px] flex-col gap-4 px-6 py-8 text-xs font-bold text-white/40 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <p>
              &copy; {new Date().getFullYear()} {PLATFORM_NAME}. Todos os
              direitos reservados.
            </p>
