...
const UrbanDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-black text-black uppercase italic tracking-tighter">Dashboard Urbano</h1>
        <p className="text-black/60 font-medium">Bem-vindo de volta! Resumo da sua carteira de imóveis tradicionais.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-lg font-bold text-black">Performance de Leads (VGV)</h3>
