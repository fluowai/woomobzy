...
export const ServiceUnavailableScreen: React.FC<ServiceUnavailableProps> = ({
  serviceError,
  onRetry,
}) => (
  <div className="flex items-center justify-center h-full min-h-[600px]">
    <div className="text-center max-w-md px-6">
      ...
      <p className="text-text-secondary mb-6 leading-relaxed">
        O painel não conseguiu consultar a API do WhatsApp. Verifique se o
        backend Node.js está online e se o proxy /api/whatsapp está chegando no
        servidor.
      </p>
