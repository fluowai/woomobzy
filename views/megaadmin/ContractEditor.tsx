...
import { Save, ArrowLeft, Building, ShieldCheck, Upload, Brain, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto pb-24">
          ...
          {id && id !== 'new' && (
            <>
              <label className="flex items-center gap-2 px-4 py-2 border border-slate-300 rounded hover:bg-slate-50 cursor-pointer">
                <Upload size={18} />
                <span>{contractFile ? contractFile.name : 'Upload Contrato'}</span>
                <input
                  type="file"
              ...
              <button
                ...
                disabled={analyzing || (!contractFile && !formData.contratante_details.nome)}
              ...
              >
                ...
                {analyzing ? 'Analisando...' : contractFile ? 'Analisar Arquivo' : 'Analisar com IA'}
              </button>
            </>
          )}
          <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-8">
        ...
        {id && id !== 'new' && (
          <section>
            <h2 className="text-lg font-semibold text-slate-800 mb-4 pb-2 border-b">4. Análise Inteligente</h2>
            <div className="bg-slate-50 rounded-lg p-6 space-y-4">
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2 px-4 py-2 border border-slate-300 rounded hover:bg-slate-100 cursor-pointer">
                  <Upload size={18} />
                  <span>{contractFile ? contractFile.name : 'Selecionar arquivo para análise'}</span>
                  <input
                    type="file"
              ...
              {analysisResult && (
                <div className="bg-white rounded-lg border border-slate-200 p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-semibold text-slate-800">Resultado da Análise</h3>
