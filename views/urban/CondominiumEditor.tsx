...
export default function CondominiumEditor() {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto pb-24 font-sans text-slate-800 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
            ...
            <span className="text-slate-300">/</span>
            <span className="text-emerald-600 font-semibold">Novo cadastro</span>
          </div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Cadastrar condomínio</h1>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm mb-6 p-4 overflow-x-auto">
        <div className="flex items-center justify-between min-w-[800px] relative">
          ...
          <div className="flex items-center gap-3 bg-white pr-4">
            <div className="w-8 h-8 rounded-full bg-emerald-600 text-white flex items-center justify-center text-sm font-bold shadow-sm">1</div>
            <div>
              <p className="text-sm font-bold text-slate-900 leading-tight">Identificação</p>
          ...
          <div className="flex items-center gap-3 bg-white pl-4">
            <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-400 flex items-center justify-center text-sm font-bold">5</div>
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 lg:p-8">
            <h2 className="text-lg font-bold text-slate-900 mb-6">Identificação do condomínio</h2>
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-64 shrink-0">
                ...
                <div className="w-full h-48 border-2 border-dashed border-slate-200 rounded-xl bg-slate-50 flex flex-col items-center justify-center cursor-pointer hover:bg-slate-100 transition-colors group relative overflow-hidden">
                  ...
                  <div className="relative z-10 flex flex-col items-center bg-white/90 p-3 rounded-lg shadow-sm">
                    ...
                    <p className="text-sm font-bold text-slate-700">Adicionar foto</p>
                    <p className="text-[10px] text-slate-500 mt-1">JPG, PNG até 5MB</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">Nome do condomínio <span className="text-red-500">*</span></label>
                  <input type="text" name="name" value={formData.name} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">Tipo <span className="text-red-500">*</span></label>
                  <select name="type" value={formData.type} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 appearance-none focus:ring-2 focus:ring-emerald-500 outline-none transition-all bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20width%3D%2220%22%20height%3D%2220%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M5%207l5%205%205-5%22%20fill%3D%22none%22%20stroke%3D%22%2394a3b8%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[position:right_0.75rem_center]">
                ...
                <div>
                  ...
                  <input type="text" name="cnpj" value={formData.cnpj} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">Incorporadora / Construtora</label>
                  <input type="text" name="developer" value={formData.developer} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-1">Ano de entrega</label>
                  <input type="text" name="deliveryYear" value={formData.deliveryYear} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="flex-1 space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                  <div className="md:col-span-2">
                    ...
                    <input type="text" name="street" value={formData.street} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">Número</label>
                    <input type="text" name="number" value={formData.number} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">Complemento</label>
                    <input type="text" name="complement" value={formData.complement} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">Bairro</label>
                    <input type="text" name="neighborhood" value={formData.neighborhood} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">Cidade</label>
                    <input type="text" name="city" value={formData.city} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">Estado</label>
                    <select name="state" value={formData.state} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 appearance-none focus:ring-2 focus:ring-emerald-500 outline-none transition-all bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20width%3D%2220%22%20height%3D%2220%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M5%207l5%205%205-5%22%20fill%3D%22none%22%20stroke%3D%22%2394a3b8%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[position:right_0.75rem_center]">
              ...
              <div className="w-full md:w-72 shrink-0">
                <div className="w-full h-full min-h-[240px] bg-emerald-50 rounded-xl overflow-hidden relative border border-emerald-100 flex items-center justify-center">
                  <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'repeating-linear-gradient(45deg, #059669 25%, transparent 25%, transparent 75%, #059669 75%, #059669)', backgroundPosition: '0 0, 10px 10px', backgroundSize: '20px 20px' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-100/50 to-blue-100/50 mix-blend-overlay"></div>
                  <MapPin size={40} className="text-emerald-600 relative z-10 filter drop-shadow-md" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 lg:p-8">
            <h2 className="text-lg font-bold text-slate-900 mb-6">Configuração inicial</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1">Total de unidades</label>
                <input type="text" name="totalUnits" value={formData.totalUnits} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1">Andares</label>
                <input type="text" name="floors" value={formData.floors} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1">Vagas</label>
                <input type="text" name="parkingSpots" value={formData.parkingSpots} onChange={handleInputChange} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none transition-all" />
              </div>
            </div>
            <p className="text-sm text-slate-500">Você poderá cadastrar blocos e unidades detalhadamente após concluir.</p>
          </div>
        ...
        <div className="w-full xl:w-[380px] shrink-0 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
            <h3 className="text-base font-bold text-slate-900 mb-6">Resumo do cadastro</h3>
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <p className="font-bold text-slate-900">{formData.name || 'Nome do condomínio'}</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  <Circle size={16} className="text-emerald-500 fill-emerald-50" />
                  <span className="font-medium text-slate-900">Identificação</span>
                </div>
          ...
          <div className="bg-[#f8fafc] border border-slate-200 rounded-2xl shadow-sm p-6">
            <h3 className="text-base font-bold text-slate-900 mb-6">O que será criado?</h3>
            ...
            <div className="space-y-6 mb-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900 leading-none mb-1.5">Página do condomínio</p>
                  <p className="text-xs text-slate-500">Página pública com informações e contatos.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900 leading-none mb-1.5">Estrutura de blocos e unidades</p>
                  <p className="text-xs text-slate-500">Cadastro organizado de blocos e unidades.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900 leading-none mb-1.5">Vínculo com imóveis e proprietários</p>
                  <p className="text-xs text-slate-500">Integração com proprietários e moradores.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-emerald-100 rounded-lg p-3 flex items-start gap-2">
              ...
              <p className="text-xs text-slate-600">Os dados poderão ser atualizados depois.</p>
            </div>
          </div>
