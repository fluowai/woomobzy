      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-1 text-sm font-medium text-slate-500">
            WhatsApp, atendimento e automação comercial.
          </p>
        </div>
        <div className="rounded-3xl border border-amber-100 bg-white p-12 text-center shadow-sm">
          ...
          <p className="mx-auto mt-2 max-w-lg text-sm text-slate-500">
            O painel urbano está pronto para gerenciar conexões, mas o serviço
            WhatsApp precisa estar online.
          </p>
          <button
            onClick={refreshInstances}
            className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-6 py-3 text-xs font-bold uppercase tracking-widest text-white"
          >
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm font-medium text-slate-500">
            Gerencie WhatsApp, atendimento, QR Code e automações da imobiliária
            urbana.
          </p>
        </div>
        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_2fr_auto] lg:items-center">
          <div>
            ...
            <p className="mt-1 text-xs font-medium text-slate-500">
              Use nomes como Atendimento, Vendas ou Locação.
            </p>
          </div>
          <div className="relative">
            ...
            <input
              ...
              placeholder={
                isLimitReached ? 'Limite do plano atingido' : 'Nome da conexão'
              }
        ...
        {loading && instances.length === 0 ? (
          ...
          <div className="col-span-full rounded-3xl border border-dashed border-slate-200 bg-white p-12 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Crie sua primeira conexão para atender leads urbanos pelo
              WhatsApp.
            </p>
          </div>
        ) : (
          instances.map((instance) => (
            ...
            >
              <div className="mb-6 flex items-center justify-between gap-3">
                ...
                <span
                  className={`rounded-full px-3 py-1 text-[10px] font-bold uppercase ${instance.status === 'connected' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-500'}`}
                >
              ...
              <div className="flex gap-2">
                {instance.status === 'connected' ? (
                  <button
                    ...
                    className="flex-1 rounded-2xl bg-red-50 px-4 py-3 text-xs font-bold uppercase tracking-widest text-red-600"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 rounded-2xl bg-blue-600 px-4 py-3 text-xs font-bold uppercase tracking-widest text-white"
                  >
                ...
                <button
                  ...
                  className="rounded-2xl bg-slate-50 px-4 py-3 text-slate-400 hover:text-red-600"
                >
                  <Trash2 size={16} />
                </button>
              </div>
